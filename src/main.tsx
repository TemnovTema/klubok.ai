...
const tasks = [
  ...
  {title:'Расписание',copy:'Перестраивает день при изменении приоритетов и защищает время для фокусной работы.',result:'План дня обновлён',image:'/assets/usecase-schedule-v3.png'},
]
